...
<div class="home-page">
    ...
    <h2 class="section-title mb-20 wow animate__ animate__fadeInUp">Annonces à la une</h2>
    ...
    <div class="border-bottom mb-30 mt-40"></div>

    <h2 class="section-title wow animate__ animate__fadeInUp">Les entreprises qui recrutent</h2>
