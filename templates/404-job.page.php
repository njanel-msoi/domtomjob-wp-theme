        ...
        <div class="row login-register-cover pb-50">
            <div class="col-lg-5 col-md-6 col-sm-12 mx-auto">
                <div class="text-center"><img class="w-75 " src="<?= get_stylesheet_directory_uri() ?>/assets/imgs/template/404.svg">
                    <h2 class="mt-10 mb-5 text-brand-1">Offre d'emploi non trouvée</h2>
                    <p class="font-sm text-muted mb-30">Cette offre a expirée ou a été supprimée par son annonceur.</p>
                </div>
