...
return [
    ...
    "region" => function () {
        return REUNION_CODE;
    }, //"region", // TODO: ["REUNION"], ou on laisse en commentaire comme toutes les offres sont à la Réunion ?
    ...
    "job_experience" => "experience", // TODO Mapping ? => 0,,
    "job_study_level" => "diplome", // TODO Mapping ? => 0,,
    ...
    "category" => "secteur", // TODO Mapping ? => 33,, 
    "type" => "contrat", // TODO Mapping ? => "INT",,
