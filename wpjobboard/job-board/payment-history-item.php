...
<div class="wpjb-grid-row wpjb-manage-item">
    ...
    <div class="wpjb-manage-actions-more">
        ...
        switch ($item->object_type) {
            case Wpjb_Model_Payment::JOB:
                $object = new Wpjb_Model_Job($item->object_id);
                break;
            case Wpjb_Model_Payment::RESUME:
                $object = new Wpjb_Model_Resume($item->object_id);
                break;
            case Wpjb_Model_Payment::MEMBERSHIP:
                $object = new Wpjb_Model_Membership($item->object_id);
                break;
            case Wpjb_Model_Payment::CAND_MEMBERSHIP:
                $object = new Wpjb_Model_Membership($item->object_id);
                break;
            default:
                $object = null;
        ...
        <div class="wpjb-grid wpjb-manage-action wpjb-col-100" style="height: auto; background-color: whitesmoke;">
            <div class="wpjb-grid-row">
                ...
                <?php if (!in_array($item->object_type, array(1, 2, 3))) : ?>
