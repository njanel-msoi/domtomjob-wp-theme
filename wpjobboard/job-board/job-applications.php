...
<?php include  dirname(__FILE__) . '/../../templates/components/dashboard/company-dashboard-header.cmpt.php' ?>

<div class="wpjb wpjb-page-job-applications box-border-single">
    ...
    <div id="wpjb-top-search" class="wpjb-layer-inside wpjb-filter-applications">
        <form action="<?php echo esc_attr(wpjb_link_to("job_applications")) ?>" method="GET">
            <div class=" d-flex">
                ...
                <div class="wpjb-search wpjb-search-group-visible d-flex">
                    <div class="wpjb-input wpjb-input-type-half wpjb-input-type-half-left mr-10">
                    ...
                    <div class="wpjb-input wpjb-input-type-half wpjb-input-type-half-left mr-20">
                ...
                <div class="wpjb-list-search">
                    <a href="#" class="btn btn-default wpjb-button-search wpjb-button-submit" title="<?php _e("Filter Results", "wpjobboard") ?>">
                        ...
                        <div class="wpjb-manage-header">
                            ...
                            <ul class="wpjb-manage-header-right">
                                ...
                                <li class="text-end">
                                    ...
                                    <span class="wpjb-manage-header-right-item-text">
                                        <?= wpjb_date_display('D d M', $application->applied_at); ?>
                                    </span>
                                </li>
